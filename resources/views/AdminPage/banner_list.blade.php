				...
				<div class="py-6 px-6 lg:px-8">
					<form class="space-y-6" action="#">
						...
						<div>
							...
							<p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">限 PNG, JPG, GIF，解析度 375 × 450 px，建議先<a class="text-orange-600" href="https://tinypng.com" target="_blank">壓縮</a></p>
						</div>
					</form>
				</div>
				<!-- Modal footer -->
