...
<body class="flex bg-gray-50">
	...
	<div class="md:w-2/3 lg:w-3/4 xl:w-5/6 2xl:w-6/7">
		<div class="py-5 px-5 w-full">
			<div class="mb-2">
				<h1 class="text-1xl md:text-2xl font-bold text-gray-600 inline-block align-middle">聯絡我們頁面設定</h1>
			</div>
				...
				<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
					<div class="justify-center">	
						...
						<div class="mb-2">
							...
							<p class="mt-1 text-sm text-gray-500 dark:text-gray-300">限 PNG, JPG, GIF，解析度___ * ___ px，建議先<a class="text-orange-600" href="https://tinypng.com" target="_blank">壓縮</a></p>
