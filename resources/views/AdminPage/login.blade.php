...
<body>
	<div class="lg:flex items-center justify-center bg-black bg-[url('https://picsum.photos/500/')] bg-opacity-5 bg-no-repeat bg-cover">
		<div class="lg:w-1/2 xl:max-w-screen-sm rounded shadow-lg bg-indigo-100 bg-blue-200 py-12 h-screen">
			<div class="py-6 flex justify-center lg:px-12">
				<div class="cursor-pointer flex items-center">
					<div>
						<img class="w-10 text-indigo-500" src="/AdminPage/img/favicon.png">
					</div>
					<div class="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold">麵匡匡拉麵食堂</div>
				</div>
			</div>
			<div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
				<h2 class="text-center text-2xl text-indigo-900 font-display font-semibold lg:text-left xl:text-5xl
				xl:text-bold">登入</h2>
				<div class="mt-12">
					<form>
						<div>
						...
						<div class="mt-8">
							...
							<input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" name="password">
						</div>
						<div class="mt-10">
