			...
			<form id="email-recipient-form">
				...
				<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-5">
					<div class="justify-center">	
						<label for="contact_us_franchise_email_recipient" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">加盟諮詢</label>
				...
				<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-5">
					<div class="justify-center">	
						<label for="contact_us_opinion_email_recipient" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">意見反映</label>
				...
				<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-5">
					<div class="justify-center">	
						<label for="contact_us_cooperation_email_recipient" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">合作諮詢</label>
