		...
		<div class="container mx-auto px-8">
			<form id="store-form">
				<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
					...
					<div class="justify-center">
						<label class="block border-l-8 border-l-[#062851] pl-2 py-1 mb-2 text-sm font-medium text-gray-900 dark:text-gray-300" for="store_file">門市地圖圖檔</label>
					...
					<div class="justify-center">	
						<label class="block border-l-8 border-l-[#062851] pl-2 py-1 mb-2 text-sm font-medium text-gray-900 dark:text-gray-300" for="city">縣市</label>
					...
					<div class="justify-center">
						<label for="address" class="block border-l-8 border-l-[#062851] pl-2 py-1 mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">完整地址</label>
					...
					<div class="justify-center">	
						...
						<div class="flex mb-2">
							<label class="flex-auto mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 w-10 align-middle">主管</label>
						...
						<div class="flex mb-2">
							<label class="flex-auto mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 w-10 align-middle">全職</label>
						...
						<div class="flex mb-2">
							<label class="flex-auto mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 w-10 align-middle">計時</label>
					...
					<div class="justify-center">
						<label for="job_url" class="block border-l-8 border-l-[#062851] pl-2 py-1 mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">104職缺網址</label>
						<input type="input" name="job_url" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="https://www.104.com.tw/jobs/main/">
					</div>
					<div class="justify-center">	
						...
						<div class="flex mb-2">
							<label class="flex-auto mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 w-10 align-middle">現金</label>
						...
						<div class="flex mb-2">
							<label class="flex-auto mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 w-10 align-middle">信用卡</label>
						...
						<div class="flex mb-2">
							<label class="flex-auto mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 w-10 align-middle">LINE PAY</label>
					...
					<div class="justify-center">	
						...
						<div class="flex mb-2">
							<label class="flex-auto mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 w-10 align-middle">自取</label>
						...
						<div class="flex mb-2">
							<label class="flex-auto mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 w-10 align-middle">外送</label>
