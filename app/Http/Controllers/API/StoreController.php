...
class StoreController extends Controller
{
    ...
    public function getStores(Request $request)
    {
        ...
        switch ($request->area) {
            case '北部':
                $store->whereIn('city',['臺北市','基隆市','新北市','新竹市','新竹縣','桃園市','宜蘭縣']);
                break;
            case '中部':
                $store->whereIn('city',['苗栗縣','臺中市','彰化縣','南投縣','雲林縣']);
                break;
            case '南部':
                $store->whereIn('city',['嘉義市','嘉義縣','臺南市','高雄市','屏東縣']);
                break;
            case '東部':
                $store->whereIn('city',['臺東縣','花蓮縣']);
                break;
            case '外島':
                $store->whereIn('city',['澎湖縣','金門縣','連江縣','南海島']);
                break;
        }
